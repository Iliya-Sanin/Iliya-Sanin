...
* CV
* GitHub repositories with my practical tasks: [SQL](https://github.com/Iliya-Sanin/SQL), [Postman](https://github.com/Iliya-Sanin/Postman), Terminal, [Git](https://github.com/Iliya-Sanin/git.git)
